        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center">
            ...
            rel="noopener noreferrer"
                className="inline-flex items-center px-8 py-4 border border-transparent text-lg font-medium rounded-full text-white bg-primary hover:bg-primary/90 transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
                {t.followInstagram}
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
                className="inline-flex items-center px-8 py-4 border border-transparent text-lg font-medium rounded-full text-white bg-[#25D366] hover:bg-[#25D366]/90 transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
                {t.joinWhatsapp}
              </a>
            </div>
